  ...
  return (
    <Modal open={open} onClose={onClose}>
      <div className="bg-sparkle-card p-4 rounded-2xl border border-sparkle-border text-sparkle-text w-[90vw] max-w-md">
        <h1 className="text-lg font-semibold mb-2">LongNhat Not Running as Admin</h1>
        <p className="text-sm mb-4">
          LongNhat is not running with administrator privileges. Some features may not work
          correctly.
        </p>
