...
const APPS_CACHE_KEY = "longnhat.apps.json"
const APPS_CACHE_TTL_MS = 1000 * 60 * 60 * 1 // this is 1 hour

const APPS_URL =
  "https://raw.githubusercontent.com/nglongnhat-bunn/optimezer-pc-by-bun/refs/heads/v2/src/renderer/src/assets/apps.json"
...
function Apps() {
  ...
  const installChocolatey = async (): Promise<void> => {
    ...
    try {
      ...
      toast.success("Chocolatey installed! Please restart LongNhat to continue.", {
        autoClose: false,
      })
      ...
      <Modal open={showWelcomeModal} onClose={() => setShowWelcomeModal(false)}>
        <div className="bg-sparkle-card border border-sparkle-border rounded-2xl p-4 shadow-xl max-w-lg w-full mx-4">
          ...
          <div className="text-sparkle-text-secondary text-sm leading-6 mb-6">
            <p className="mb-4">
              LongNhat can install apps using either{" "}
      ...
      <RootDiv>
        ...
        <div className="space-y-10 mb-10">
          ...
          <p className="text-center text-sparkle-text-muted">
            ...
            <a
              href="https://github.com/nglongnhat-bunn/optimezer-pc-by-bun"
              target="_blank"
