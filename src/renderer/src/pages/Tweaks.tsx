                          ...
                          <>
                            ...
                            {tweak.addedversion &&
                              isNewInCurrentVersion(tweak.addedversion, CURRENT_VERSION) && (
                                <Tooltip
                                  content={`New in LongNhat ${tweak.addedversion}`}
                                  delay={0.3}
                                  side="right"
                                >
                            ...
                            {tweak.updatedversion &&
                              isUpdatedInCurrentVersion(tweak.updatedversion, CURRENT_VERSION) && (
                                <Tooltip
                                  content={`Updated in LongNhat ${tweak.updatedversion}`}
                                  delay={0.3}
                                  side="right"
                                >
                      ...
                      <div className="flex items-center m-0 gap-2">
                        <Button
                          ...
                          onClick={(e) => {
                            ...
                            const url = `https://docs.github.com/nglongnhat-bunn/tweaks/${tweak.name}`
